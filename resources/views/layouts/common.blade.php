...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendor/revolution-slider/revolution/css/settings.cs') }}s">
            ...
            <div class="row justify-content-between align-items-center g-mx-0--lg">
              ...
              <div class="col-6 col-sm-auto order-sm-3 g-py-5 g-pr-0 g-py-20--sm">
                ...
                <div class="d-inline-block">
                  <a class="u-icon-v1 g-color-text g-color-black--hover g-color-black--focus g-font-size-16 g-text-underline--none--hover" href="{{ url('/login') }}">
